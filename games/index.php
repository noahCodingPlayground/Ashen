...
echo "
<div class='game-card' <div class='game-card' onclick=\"window.location.href='/ashen/display/index.php?f=showApp&app=https://noah.customcloudapp.net/ashen/games/$gameFile'\">
